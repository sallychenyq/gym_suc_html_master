  ...
  <u-navbar placeholder @leftClick="none()" :border="false" :auto-back="true">
    ...
    <view slot="left">
      ...
      <view
        ...
        @tap.stop="showQr"
        :style="{
          height: `${qrButtonViewStyle.height}px`,
          width: `${qrButtonViewStyle.width}px`,
          borderRadius: `${qrButtonViewStyle.border}px`,
        }"
        :class="
          'btn-qr-container ' +
          (showQrButton && !showBackBtn ? '' : 'hide ') +
          (qrButtonTip ? 'tips' : '')
        "
      >
        <image
          src="@/static/imgs/header-qr-button.png"
          class="btn-qr"
          :style="{
            height: `${qrButtonStyle.height}px`,
            width: `${qrButtonStyle.width}px`,
          }"
        />
      </view>
    </view>
...
import QrBox from "../qr-box/qr-box.vue";

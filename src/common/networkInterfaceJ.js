...
export function huihomeInterFace(method, addr, conf) {
  return generalRequest.bind(
    null,
    addr,
    huihomeAjaxHookBefore,
    huihomeAjaxHookAfter,
    method,
    conf
  );
}
...
export const coachType = huihomeInterFace(
  "get",
 ...
 * 个人相关
 */
export const getMyBodyTestData = huihomeInterFace(
  "get",
  "/user/getMyBodyTestData",
  {
    loading: "正在获取体测数据",
  }
);
...
export const checkNeedSignAgreement = huihomeInterFace(
  "get",
  "/vipCard/needSignAgreement"
);
...
export const setBalanceRechargeOrderWx = huihomeInterFace(
  "post",
  "/balance/rechargeWx",
  {
    loading: "正在创建订单",
...
export const cancelAppoint = huihomeInterFace(
  "post",
  "/sitePack/cancelAppoint",
  {
    loading: "正在取消预约",
  }
);
...
export const appointCourse = huihomeInterFace(
  "post",
  "/appoint/appointCourse",
  {
    loading: "正在预约",
    errBox: "预约失败",
  }
...
export const cancelAppointCourse = huihomeInterFace(
  "post",
  "/appoint/cancelAppointCourse",
  {
    loading: "正在取消",
    errBox: "取消失败",
  }
);
export const cancelAppointLive = huihomeInterFace(
  "post",
  "/appoint/cancelAppointLive",
  {
    loading: "正在取消",
    errBox: "取消失败",
  }
...
export const appointDutyTime = huihomeInterFace(
  "post",
  "/coach/dutyTimeAppoint",
  {
    loading: "正在预约",
    errBox: "预约失败",
  }
);
export const dutyTimeCancelAppoint = huihomeInterFace(
  "post",
  "/coach/dutyTimeCancelAppoint",
  {
    loading: "正在执行",
    errBox: "取消失败",
  }
...
export const lastUnAssessAppoint = huihomeInterFace(
  "get",
  "/appoint/lastUnAssessAppoint"
);
/**
 * 小班课
 * 小班课
 */
export const getCoursePersonalOne = huihomeInterFace(
  "get",
  "/course/getOnePersonal"
);
export const signCoursePersonal = huihomeInterFace(
  "post",
  "/coursePersonal/sign",
  {
    loading: "正在进行签约",
 ...
 * 门店相关
 */
export const getCanChangeToCorps = huihomeInterFace(
  "get",
  "/user/getCanChangeToCorps",
  {
    loading: "正在获取列表",
  }
);
export const changeCorpByCode = huihomeInterFace(
  "get",
  "/user/changeCorpByCode",
  {
    loading: "正在前往门店",
  }
);
 ...
 * 消息相关
 */
export const WXMPMessageTempIds = huihomeInterFace(
  "get",
  "/message/WXMPMessageTempIds",
  {
    loading: "正在获取信息",
  }
);
